...
Поскольку доработка модели не привела к улучшению ее качества, было принято решение сформировать ансамбль из 2
моделей, в котором одна модель будет обучена сегментировать крупные ишемические очаги, а другая - мелкие. Для этого 
маски исходной сегментации были разделены на маски отдельно только крупных и только мелких очагов.
...
|:-------:|:---------:|:----:|:-------------:|:----:|:----:|:-----:|
|  0.92   |   0.89    | 0.91 |     0.95      | 0.67 | 0.54 | 29.65 |
...
| Vетрика для мелких очагов        | 0.36 | 0.26 | 3.00 |
...
очагами инсульта. Сопоставимый результат в группе множественных смешанных очагов достигается за счет большего вклада 
крупных очагов в рассматриваемые метрики
...
Precision, recall и f1 на уровне очагов
...
Данные метрики показывают, что модели свойственно генерировать множество ложных очагов или разбивать один истинный очаг 
на множество мелких. При этом модель лучше справляется с обнаружением очагов крупного размера. Аналогичные метрики
без порога перекрытия сегментаций показывают более высокие значения recall c сохранением низкого recision
...
качества. После чего был реализован ансамбль моделей сегментации очагов разного размера. Итоговая модель показывает 
высокое качество детекции ишемического поражения у пациента, умеренное качество сегментации ишемических очагов объемом 
более 44 мм3 и низкое качество сегментации очагов объемом менее 44 мм3, а также склонность генерировать ложные очаги
и разбивать единые очаги на несколько отдельных.
